  ...
  <div>
    <div class="glide details" ref="carouselImages">
      <div data-glide-el="track" class="glide__track">
        <div class="glide__slides">
          <div
            v-for="(item, index) in settingsImages.data"
            :key="`glide_${index}`"
          >
    ...
    <div class="glide thumbs" ref="carouselThumbs">
      <div data-glide-el="track" class="glide__track">
        <div class="glide__slides">
          <div
            v-for="(item, index) in settingsThumbs.data"
            :key="`thumb_${item.id}`"
            :class="
              index === activeIndex ? 'glide__slide active' : 'glide__slide'
            "
  ...
  data() {
    return {
      ...
      thumbsPerView: Math.min(
        this.settingsThumbs.perView,
        this.settingsImages.data.length
      ),
      renderArrows: true,
      resizeTimeOut: -1,
      mountTimeOut: -1
